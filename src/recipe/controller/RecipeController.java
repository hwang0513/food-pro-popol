...
public class RecipeController extends HttpServlet {
	...
	private void deleteRecipe(HttpServletRequest request, HttpServletResponse response) throws IOException {
		int recipe_id = Integer.parseInt(request.getParameter("id")); // id를 받음
	...
	private void insertRecipe(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.sendRedirect("recipes?action=list&category=" + category); // 새 레시피를 저장하고 리스트 페이지로 이동
	}
	...
	private void listRecipe(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
