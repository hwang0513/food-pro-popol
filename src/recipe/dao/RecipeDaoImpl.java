...
public class RecipeDaoImpl implements RecipeDao {
	...
	@Override
	public List<Recipe> showMostViewCountRecipeByCategory(String category) {
		List<Recipe> boards = new ArrayList<>();

		String sql = "SELECT recipe_id, recipeName, regDate FROM (SELECT * FROM recipe WHERE category = ? ORDER BY recipe_id) AS recipeOrder ORDER BY viewCount DESC LIMIT 1";
