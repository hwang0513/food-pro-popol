...
public class Recipe {
	...
	// 메인페이지용 생성자
	public Recipe(int recipe_id, String recipeName, LocalDate regDate) {
	...
	// 다 있는 생성자
	public Recipe(int recipe_id, String userName, String category, String recipeName, String description,
